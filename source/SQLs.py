...
sqlCREATEepisodes = "CREATE TABLE episodes (castid INTEGER NOT NULL, episodeid INTEGER NOT NULL, episodeURL TEXT NOT NULL, episodeNAME TEXT NOT NULL, status INT NOT NULL, UNIQUE(castid, episodeid), UNIQUE(castid, episodeURL));"
